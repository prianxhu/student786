...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: **Priyanshu Singh**")
    st.markdown("🔗 GitHub: [Priyanshu Singh](https://github.com/prianxhu)")
    st.markdown("🔗 LinkedIn: [Profile](www.linkedin.com/in/priyanshu-singh-946001287)")
    st.markdown("---")
